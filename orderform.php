...
<head>
    <meta charset="UTF-8">
    <title>Lecture : AgriComercio</title>
...
<?php
    if(isset($_POST['item_id'])){
        ...
        mysqli_stmt_bind_param($stmt_ins,"ssss",$cust_id,$item_id,$item_qty,$item_status);
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                              <label for="" class="form-label">Item ID</label>
                               <input class="form-control" name="item_id" type="text" value="<?php echo $_GET['item_id']; ?>">
