...
<header id="header">
    ...
    <div class="category-cont">
        <div class="category-slider">
            ...
            <div class="page-btn">
                <a href="vegetable.php">1</a>
                <a href="vegetable_two.php">2</a> 
                <a href="vegetable_three.php">3</a>            
            </div>
