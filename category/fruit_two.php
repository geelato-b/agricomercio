...
<header id="header">
    ...
    <div class="category-cont">
        <div class="category-slider">
            ...
            <div class="page-btn">
                <a href="fruits.php">1</a>
                <a href="fruit_two.php">2</a>            
            </div>
