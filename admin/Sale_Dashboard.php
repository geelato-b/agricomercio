...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="index.php"> <i class="fas fa-home"></i> </a>
                                ...
                                <div class="card-body">
                                    ...
                                    foreach($item_categ as $x => $ic){ ?>
                                        <span class="list-group-item">
                                            <?php
                                    $item_sale =  query($conn, "SELECT sum(i.item_price * c.item_qty) total_net_sales, sum(c.item_qty) total_ordered  FROM `cart` c JOIN `items` i on (i.item_id = c.item_id) WHERE i.item_id = ? and c.status in ('C','X') and cart_status = 'X' and date_ordered >= CURRENT_DATE - 30; ", array($ic['item_id'])); 
