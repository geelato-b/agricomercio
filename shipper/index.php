...
<div class="sidenav">
  ...
  <a href="index.php"><i class="fas fa-truck"></i> Orders Delivery </a>
    ...
    <tbody>
        ...
        <div class="cart_card">
          ...
          <td>
           ...
           <td>
            <div class="cart_card">
                <form action="../includes/shipperorderupdate.php" method="post">
                            ...
                            <p class="lead"><?php echo $row['tracking_order_status'] == 'P' ? 'For Delivery' : 'Delivered' ; ?></p>
                            <button class="btn btn-success"> 
                              <?php echo $row['tracking_order_status'] == 'P' ? 'Delivered' : 'Not Delivered' ; ?> </button>
